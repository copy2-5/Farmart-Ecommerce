...
export const AppProductDynamicVisual: React.FC<APV_DynamicProps> = ({ baseConfig, pagInfos, attachComponent, type }) => {
  return (
        ...
        type === "base" ? (
          <div className={`${baseConfig.className}__heading`}>
            <div className={`${baseConfig.className}__heading-left`}>
              ...
              <a href={'https://google.com'}>{baseConfig.urlTag} <IoIosArrowForward /></a>
            ...
            <Swiper
              ...
              className={`${baseConfig.className}-swiper`}>
              {
                baseConfig.swiperData.map((data: any, index: number) => (
                  <SwiperSlide className={`${baseConfig.className}__content-card`} key={index}>
                    <div className={`${baseConfig.className}__content-card-logo`}>
                      <div className='set-favorite-button'><BsHeart /></div>
                      {data.saver && <div className='banner-saver'>Save {data.saverNote}%</div>}
                    </div>
                    <div className={`${baseConfig.className}__content__review`}>
                      ...
                      {
                        attachComponent && (
                          <div className={`${baseConfig.className}__content__review-specify`}>
                            <div className={`${baseConfig.className}__content__review-specify__origin`}>
                              <div className='stars'>
                                {
                                  mob.map((_, index) => (
                                  ...
                                  data?.saver ?
                                    (
                                      <div className='saver-review'>
                                        <p className='price'>${data.price} <span>${data.oldPrice}</span></p>
                                      </div>) :
